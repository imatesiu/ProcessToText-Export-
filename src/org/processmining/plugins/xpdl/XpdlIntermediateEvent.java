 ...
 *         value="Error"/> <xsd:enumeration value="Cancel"/> <xsd:enumeration
 ...
 *         type="xpdl:Id" use="optional"> <xsd:annotation>
 *         <xsd:documentation>BPMN: Presence of attribute indicates attached
 *         intermediate event; attribute value points to the BPMN activity (task
 *         or subprocess) the event is attached to. Absence of the attribute
 *         indicates intermediate event in sequence flow. Pointer to
 *         Activity/@Id, where activity type must be a task or subprocess.
