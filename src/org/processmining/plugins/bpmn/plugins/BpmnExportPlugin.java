 ...
 * Aug 21, 2013
 */
@Plugin(name = "BPMN XML 2.0 export", returnLabels = {}, returnTypes = {}, 
...
public class BpmnExportPlugin {
	...
	public void export(UIPluginContext context, BPMNDiagram bpmnDiagram, File file) throws IOException {
	 ...
	 */
	@PluginVariant(variantLabel = "BPMN XML 2.0 export", requiredParameterLabels = { 0, 1 })
	public void export(UIPluginContext context, BpmnDefinitions definitions, File file) throws IOException {
	 ...
	 * @param bodyString
	 */
	private void exportWithContent(UIPluginContext context, File file, String bodyString) throws IOException {
	 ...
	 */
	private void exportEnvelope(UIPluginContext context, XMLStreamWriter writer)
			throws XMLStreamException {
	 ...
	 * @return
	 */
	private String retrieveContent(UIPluginContext context, BPMNDiagram diagram) {
